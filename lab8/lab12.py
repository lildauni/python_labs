...
class ComplexNum:
  ...
  def __truediv__(self, other):
    return ComplexNum((self.real * other.real + other.i * other.i)/(other.real ** 2 + other.i ** 2), (other.real * self.i - self.real * other.i)/(other.real ** 2 + other.i ** 2))
  ...
  def get_roots(self, base):
    ...
    for k in range(0, base + 1):
      complex_root = ComplexNum(math.sqrt(self.z) * (math.cos(self.φ + 2 * math.pi * k) / base), math.sqrt(self.z) * (math.sin(self.φ + 2 * math.pi * k) / base))
